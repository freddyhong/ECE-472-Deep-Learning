...
"""
    First, I just applied same weight for all linear model. While the shape of the result was spiral, it was very noisy and spiky.
    ...
    Then from here, to soften the spiral, I changed the hyperparameters such as learning rate, hidden layer width, depth and batch size.
